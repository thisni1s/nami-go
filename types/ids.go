...
const (
	...
	NICHTMITGLIED MITGLIEDTYPEID = "NICHT_MITGLIED"
	SCHNUPPER     MITGLIEDTYPEID = "SCHNUPPER_MITGLIED"
)
...
const (
	...
	INAKTIV    MITGLIEDSTATUSID = "INAKTIV"
	ARCHIVIERT MITGLIEDSTATUSID = "GELOESCHT_ALT"
)
